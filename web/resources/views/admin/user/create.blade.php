	...
	<div class="row" id="form">
								...
								<div class="row">
									<div class="image-upload col-sm-3" style="margin-bottom: 50px;">
										<label for="fileButton">
											<img src="{{ asset('/images/admin.jpg') }}" alt="avatar" class="user-avatar" id="photo" style="border-radius: 50%;width: 150px;height:150px;">
										</label>
		...
		<script>
			...
			button.onclick =  function(){
				var avatar1 = $("input[name=ava]").val()
