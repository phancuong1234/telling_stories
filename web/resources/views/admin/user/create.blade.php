		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					...
					@endforeach
					@endif
					<form action="{{ route('user.create') }}" method="post" accept-charset="utf-8" >{{-- enctype="multipart/form-data" --}}
						@csrf
						<div class="row">
...
<script>
	...
	button.onclick =  function(){
		console.log("hsdfhsfhs"+document.getElementById("fileButton").value);
		var firebaseConfig = {
...
uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, // or 'state_changed'
  ...
  uploadTask.snapshot.ref.getDownloadURL().then(function(downloadURL) {
  	...
  	var _img = document.getElementById('filrButton');
